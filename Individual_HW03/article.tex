...
\noindent Known that $i = e ^{i \theta} = e ^{i \frac{\pi}{2}}$, we have its 4th roots being $e^{i (\frac{\theta}{k} + \frac{2j\pi}{k})}$ for $k = 4$ and $j = 0, 1, 2, 3$. So the 4th roots are $e^{i (\frac{\pi}{8} + \frac{j \pi}{2})}$ for $j = 0, 1, 2, 3$ and $r^4 = 1 \Longrightarrow r = \pm 1$. Here's the plotting of these roots where each root is marked in red:
